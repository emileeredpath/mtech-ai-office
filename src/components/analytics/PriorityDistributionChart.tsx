    ...
    <div className="bg-[#1D2A3A] rounded-xl p-5 border border-[#3a4f6a]">
      ...
      <ResponsiveContainer width="100%" height={300}>
        <BarChart data={lastSevenDays}>
          ...
          />
          <Legend wrapperStyle={{ color: '#8F9194' }} />
          <Bar dataKey="highPriority" stackId="priority" fill="#EF4444" name="High" isAnimationActive={true} />
          <Bar dataKey="mediumPriority" stackId="priority" fill="#F9701F" name="Medium" isAnimationActive={true} />
          <Bar dataKey="lowPriority" stackId="priority" fill="#3B82F6" name="Low" isAnimationActive={true} />
        </BarChart>
      </ResponsiveContainer>
    </div>
  );
